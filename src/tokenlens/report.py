...
def render_session(report: SessionReport, findings: Sequence[Finding],
    ...
    out.append(table(
        ...
        [
            ...
            ["Cache write (1h, 2x input)", tokens(u.cache_write_1h_tokens), money(c.cache_write_1h_cost), ""],
            ["Cache write (5m, 1.25x input)", tokens(u.cache_write_5m_tokens), money(c.cache_write_5m_cost), ""],
